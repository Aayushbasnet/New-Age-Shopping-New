...
class ProductAdmin(admin.ModelAdmin):
    list_display    =   ['user','product_category','product_name', 'product_description','product_price',  'product_quantity', 'product_availability', 'product_discount', 'product_image_src']
